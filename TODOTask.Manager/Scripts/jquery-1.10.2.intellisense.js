...
intellisense.annotate(jQuery, {
  ...
  'inArray': function() {
    ...
    ///   <param name="fromIndex" type="Number">The index of the array at which to begin the search. The default is 0, which will search the participantle array.</param>
    ///   <returns type="Number" />
    /// </signature>
  },
  'isArray': function() {
  ...
  'proxy': function() {
    ...
    ///   <param name="function" type="Function">The function participantse context will be changed.</param>
    ...
    ///   <param name="name" type="String">The name of the function participantse context will be changed (should be a property of the context object).</param>
    ///   <returns type="Function" />
    /// </signature>
    /// <signature>
    ///   <summary>Takes a function and returns a new one that will always have a particular context.</summary>
  ...
  'sub': function() {
    /// <summary>Creates a new copy of jQuery participantse properties and methods can be modified without affecting the original jQuery object.</summary>
    /// <returns type="jQuery" />
  },
  'support': function() {
